...
public abstract class GameObject {
    public static GameObject newInstance(String type, float x, float y, GameWorld gameWorld) {
        return switch (type) {
            ...
            case "00" -> new Bullet(x, y, ResourceManager.getSprite("bullet"), 0, (short) 180,gameWorld);
